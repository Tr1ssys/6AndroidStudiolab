...
import com.example.AndroidStudiolab6.Cart;
...
public class MainViewPagerAdapter extends RecyclerView.Adapter<MainViewPagerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final Item item = ItemInfo.getInstance().getAvailableItems().get(position);
    ...
    public int getItemCount() {
        return ItemInfo.getInstance().getAvailableItems().size();
    }
