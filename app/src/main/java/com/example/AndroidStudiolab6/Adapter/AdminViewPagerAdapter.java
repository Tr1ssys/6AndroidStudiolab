package com.example.AndroidStudiolab6.Adapter;
...
import com.example.AndroidStudiolab6.Item;
...
public class AdminViewPagerAdapter extends RecyclerView.Adapter<AdminViewPagerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        final Item item = ItemInfo.getInstance().getItems().get(position);
        ...
        holder.change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    ItemInfo.getInstance().updateItem(updatedItem);
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ItemInfo.getInstance().deleteItem(item.getId());
                click.click(position);
            }
        });
    }
    ...
    public int getItemCount() {
        return ItemInfo.getInstance().getItems().size();
    }
